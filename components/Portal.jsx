    ...
    <div className="portal">
      ...
      <div className={`gate grainy ${entered ? "gone" : ""}`}>
        <div className="gate-logo">
          ...
          <img src="/sungate-icon.jpg" alt="Sungate Records" onError={(e) => (e.currentTarget.style.display = "none")} />
        </div>
      ...
      <div className={`view ig ${mode === "ig" ? "active" : ""}`}>
        <div className="ig-header">
          <div className="ig-logo">
            <img src="/sungate-icon.jpg" alt="" onError={(e) => (e.currentTarget.style.display = "none")} />
            <div className="word">sungate <span>records</span></div>
          </div>
        </div>
      ...
      <div className="switcher grainy">
        {reviewCount > 0 && (
          <button className="brand" style={{ color: "var(--mustard)", border: "none", background: "none", cursor: "pointer", fontFamily: "inherit" }} onClick={onGoToReview}>
